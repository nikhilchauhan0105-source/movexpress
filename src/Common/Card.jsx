...
export const Card = ({ icon, head, subhead, url }) => {
  ...
  return (
    <div
      className="group  "
      onClick={() => navigate("manvanservices")}
    >
...
export const Workcard = ({ icon, steps, head, subhead }) => {
  return (
    <div
      data-aos="fade-right"
      className="p-[24px] transition-all duration-200 h-[265px] cursor-pointer group hover:bg-purple hover:text-white text-center flex flex-col items-center rounded-xl bg-[#F6F7F9]"
    >
