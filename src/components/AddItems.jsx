import { Box, Cross, CrossIcon, Plus, X } from "lucide-react";
      ...
      <div className="w-full shadow-sm/30 rounded-xl max-h-[200px] custom-scrollbar overflow-y-scroll  bg-blue-300/10 mt-4 py-2 px-2 ">
        ...
        if (!hasQuantity) return null; 
          return (
            ...
            >
              <button
                className="absolute right-1.5 shadow-xs/30 shadow-amber-600 rounded-xs p-0.5 top-1.5 "
              >
              ...
              {Object.keys(quantities[category]).map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[8px] sm:text-xs sm:px-2  px-1 sm:py-0.5 shadow-amber-600 shadow-xs/40 rounded-sm sm:rounded-lg">
