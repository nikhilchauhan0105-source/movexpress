...
export const Footer = () => {
  return (
    <footer className="bg-lightpurple px-3">
      <div className="lg:flex-row flex-col lg:items-start items-center flex gap-8 justify-between  max-w-[1296px] pt-10 lg:pt-32 m-auto">
        <div className="max-w-[428px]">
          ...
          <p className="font-normal max-w-[390px] text-sm text-black/80 lg:text-lg mt-7">
        ...
        <div className="flex lg:flex-row flex-col gap-5 lg:gap-[72px]">
          <ul className="flex flex-col gap-1 lg:gap-1.5">
            <h2 className="text-xl font-medium mb-3 text-purple">Quick Link</h2>
            {quicklinklist.map((link, index) => (
              <li key={index} className=" lg:text-lg font-medium">
                <a href=""> {link}</a>
              </li>
            ))}
          </ul>
          ...
          <ul className="flex flex-col gap-1 lg:gap-1.5">
            <h2 className="text-xl font-semibold mb-3 text-purple">Small Print</h2>
          ...
          <div className="max-w-[180px]">
            <h2 className="text-xl font-semibold mb-3 text-purple">Contact Info</h2>
            <div className=" lg:my-3 font-medium">
              <p className=" lg:text-lg">
                6566 Union Street, San Francisco CA 65456, United States
              </p>
              <p className="lg:text-lg ">(555) 123-4567</p>
            </div>
      ...
      <div className="border-t-1 text-purple border-purple py-10 max-w-[1295px] m-auto mt-5 lg:mt-32">
