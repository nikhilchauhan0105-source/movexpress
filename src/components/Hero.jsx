...
const Hero = () => {
  ...
  const [selectvan, setSelectvan] = useState("");
  console.log(formStpes);
  ...
  return (
    <>
      <selectedvanContext.Provider value={{ choosevan, setChoosevan }}>
        <section className=" bg-purple px-3 text-white relative">
          ...
          >
            ...
            <div className="max-w-[644px] w-full  p-[22px]  md:p-[18px] lg:py-6 mb-1.5 lg:p-6 text-black bg-white rounded-2xl">
              ...
              {formStpes === "when-moves" && <When whichvan={selectvan} />}
            </div>
          </div>
        </section>
