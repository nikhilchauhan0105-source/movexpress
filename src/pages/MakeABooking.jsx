  ...
  return (
    <section>
      ...
      <div className="max-w-[1296px] px-3 pb-20 gap-6 xl:gap-0 flex-col mb-16  flex xl:flex-row justify-between mt-20 m-auto">
          ...
          <p className="text-textlight leading-[170%]">
            ...
            road quickly.
              ...
              <p className="text-textlight my-6">
                If you are unsure which van size is most appropriate for your
                move based on the volume of your belongings, feel free to
              ...
              <p className="text-textlight my-6">
                Assistance is especially helpful when transporting massive
                items, though it can also be required for anything that may not
                fit into a typical car.
              </p>
              <MakeABookingSub
              ...
              <p className="text-textlight my-6">
                You can also decide how many hours you need the van and have
                enough time to load and unload your items.
              </p>
              <div className="max-w-[728px]">
                ...
                <p className="text-textlight my-6">
                  As with every step or task, double-check everything to ensure
                  it is in order before moving on to the next phase.
                </p>
              </div>
              <div className="max-w-[728px]">
                <MakeABookingSub
              ...
              <div className="mt-6">
                ...
                <div className="max-w-[496px] my-6">
                  ...
                  <p className="leading-[170%] text-[#0D2440] mt-3">
                    Enter your data and plan your next trip; use the application
        ...
        <div className="max-w-[414px] flex flex-col sticky top-10 h-fit  gap-4">
